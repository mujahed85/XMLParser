...
namespace iTextSharp.tutorial.Chapter1
{
	...
	/// </summary>
	public class PdfTableCreate
    {
		public PdfTableCreate()
		{
			string appRootDir = new DirectoryInfo(Environment.CurrentDirectory).Parent.Parent.FullName;
			try
			{
				// Creating System.IO.FileStream object
				using (FileStream fs = new FileStream(appRootDir + "/PDFs/" + "PdfTableCreate.pdf", FileMode.Create, FileAccess.Write, FileShare.None))
